...
const Skills = () => {
  return (
    // <div className="block h-full px-6 bg-white md:px-10 page-shadow">
    ...
    //     {/* skills section */}
    //     <div className="my-6 space-y-2 text-lg h-[350px] md:mt-4 md:space-y-4 md:text2xl sm:block md:h-full">
